...
function ReportFeetback({ visible, setVisible }) {
	...
	const [topic, setTopic] = useState([
		{ label: "Account and privacy", value: "Account and privacy" },
		{ label: "Stability and perfomance", value: "Stability and perfomance" },
