...
function Preferences({ visible, setVisible, onContinue }) {
	...
	const handleSave = () => {
		if (activities.length === 0 || social.length === 0)
			return alert("You need to select at least one");
				...
				>
					...
					<View>
						...
						<Text style={{ color: themeColor.secondaryText }}>
							Help us get to know you! We'll use your preferences to recomment
							spots that match your interest.
						</Text>
