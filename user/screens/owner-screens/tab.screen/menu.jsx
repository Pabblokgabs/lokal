...
import SettingModal from "../../../components/owner/modal/setting.modal";
			...
			>
				<View style={{ paddingHorizontal: 15 }}>
					<TopBar
						...
						I_press={() => navigation.navigate("notification")}
					/>
				</View>
				...
				<ScrollView showsVerticalScrollIndicator={false}>
					...
					<View style={{ paddingHorizontal: 15 }}>
						...
						>
							<Text style={[reusableStyles.lgHeader, { color: "white" }]}>
								Premium
							</Text>
							<TouchableOpacity
								style={{
							...
							>
								<Text style={[reusableStyles.text, { color: "white" }]}>
									Subscribe
								</Text>
							</TouchableOpacity>
						</View>

						<LinkTile title={"Subscription"} />
